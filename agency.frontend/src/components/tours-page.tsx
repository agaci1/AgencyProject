...
import { MapPin, Users, Star, Clock, ArrowLeft } from "lucide-react"
...
export function ToursPage({ isLoggedIn, user, onLogout, onBackToHome, onLoginClick, onOpenAbout }: ToursPageProps) {
  ...
  onNavigate={(page) => {
    ...
    else if (page === "bookings") console.log("Go to bookings (optional)") // or your real function
  }}
/>
            ...
            {displayedTours.map((tour) => (
              <Card key={tour.id} className="overflow-hidden hover:shadow-lg transition-shadow flex flex-col h-full">
                <div className="relative">
                  ...
                  <Badge className="absolute top-4 left-4 bg-white text-gray-900">{tour.duration}</Badge>
                ...
                <CardHeader className="flex-grow">
                  ...
                  {tour.startLocationLink && (
                    <div className="text-sm text-blue-600 underline mb-4">
                      <a href={tour.startLocationLink} target="_blank" rel="noopener noreferrer">
                ...
                <CardContent className="pt-0 mt-auto">
                  <div className="space-y-4">
                    ...
                    <Button className="w-full h-12 text-base font-medium" onClick={() => handleTourSelect(tour)}>
          ...
          {!showAllTours && (
            <section className="py-20 px-4">
              <div className="container mx-auto text-center">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready for Your Albanian Alps Adventure?</h2>
                <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                  Discover more amazing tours and start planning your unforgettable journey through the Albanian Alps.
                </p>
                <Button
                  size="lg"
