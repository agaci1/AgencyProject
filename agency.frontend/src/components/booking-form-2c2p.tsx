...
export function BookingForm({ tour, onComplete, onCancel }: BookingFormProps) {
  ...
  const handle2C2PPayment = async () => {
    ...
    try {
      ...
      const paymentUrl = `https://demo2.2c2p.com/2C2PFrontEnd/RedirectV3/payment?merchantID=JT01&invoiceNo=${res.data.id}&description=${encodeURIComponent(tour.title)}&amount=${finalTotal}&currencyCode=EUR&paymentChannel=ALL`
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Complete your payment securely with 2C2P</CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900 mb-2">Secure Payment with 2C2P</h4>
                    <ul className="text-sm text-blue-800 space-y-1">
                      ...
                      <li>• Albania supported payment processor</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                {isProcessing && (
                  <div className="text-center text-sm text-gray-600 font-playfair">Redirecting to secure payment page...</div>
                )}
              </div>
